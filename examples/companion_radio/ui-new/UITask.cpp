  ...
  int render(DisplayDriver& display) override {
    ...
    if (_page == HomePage::FIRST) {
      ...
      if (_task->hasConnection()) {
        ...
        #endif
      // CUSTOM (TeTeHacko): jen kdyz BT opravdu bezi -- jinak displej nabizi PIN
      // k parovani, ktere neni jak navazat.
      } else if (the_mesh.getBLEPin() != 0 && _task->isBluetoothEnabled()) { // BT pin
        display.setColor(UIColor::warning_txt);
